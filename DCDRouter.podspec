...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/dingchuandong/test/blob/master/README.md"
  ...
  s.source       = { :git => "https://github.com/dingchuandong/test.git", :tag => "#{s.version}" }
